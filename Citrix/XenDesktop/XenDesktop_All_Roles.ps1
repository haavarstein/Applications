...
$UnattendedArgs = '/quiet /noreboot /configure_firewall /ignore_hw_check_failure'
...
(Start-Process "XenDesktopServerSetup.exe" -ArgumentList $unattendedArgs -Wait -Passthru).ExitCode
