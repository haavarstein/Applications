...
$Version = "1904"
$PackageName = "AdminCenter"
$InstallerType = "msi"
$Source = "$PackageName" + "." + "$InstallerType"
$LogPS = "${env:SystemRoot}" + "\Temp\$Vendor $Product $Version PS Wrapper.log"
$LogApp = "${env:SystemRoot}" + "\Temp\$PackageName.log"
$Destination = "${env:ChocoRepository}" + "\$Vendor\$Product\$Version\$packageName.$installerType"
$strThumb = Get-Content "$Certificates\Wildcard.txt"
$UnattendedArgs = "/i $PackageName.$InstallerType ALLUSERS=1 /qn /liewa $LogApp SME_PORT=443 SME_THUMBPRINT=$strThumb SSL_CERTIFICATE_OPTION=installed"
