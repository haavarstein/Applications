...
$Vendor = "Misc"
$Product = "Wireshark"
$PackageName = "Wireshark-win64"
#$Evergreen = Get-NotepadPlusPlus | Where-Object {$_.Architecture -eq "x64"}
$Version = (Invoke-WebRequest -Uri 'https://wireshark.org/download/win64'|Select -ExpandProperty Links|Where-Object {$_.Innertext -match '\d+\.\d+\.\d+' }|ForEach-Object { $matches[0] -as [version] }|Sort-Object -Descending|Select-Object -First 1).ToString()
