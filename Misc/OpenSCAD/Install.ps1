# Get latest version and download latest OpenSCAD release via GitHub API
...
$releases = $latestRelease.assets | Where-Object { $_.name -like "OpenSCAD*" } | `
...
$Version = $latestVersion.Trim("openscad-")
$InstallerType = "exe"
$Source = "$PackageName" + "." + "$InstallerType"
$LogPS = "${env:SystemRoot}" + "\Temp\$Vendor $Product $Version PS Wrapper.log"
$LogApp = "${env:SystemRoot}" + "\Temp\$PackageName.log"
$Destination = "${env:ChocoRepository}" + "\$Vendor\$Product\$Version\$packageName.$installerType"
$url = "https://files.openscad.org/OpenSCAD-$Version-x86-64-Installer.exe"
$UnattendedArgs='/S'
